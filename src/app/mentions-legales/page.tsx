        ...
        <div className="space-y-10 text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <div className="bg-[#242428] rounded-lg p-4 border border-[#D4AF37]/20">
              ...
              <p>France</p>
              <p className="mt-3">Email : <a href="mailto:mg.events35@gmail.com" className="text-[#D4AF37] hover:underline">mg.events35@gmail.com</a></p>
          ...
          <section>
            ...
            <p className="mt-4">
              Pour exercer ces droits, contactez-nous à : <a href="mailto:mg.events35@gmail.com" className="text-[#D4AF37] hover:underline">mg.events35@gmail.com</a>
            </p>
          </section>
