        ...
        <div className="space-y-10 text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc ml-6 space-y-1">
              <li>L&apos;accès à 4 jeux interactifs (Roue de la Destinée, Photo Mystère, Quiz, Le Bon Ordre)</li>
          ...
          <section>
            ...
            <p className="mb-4">
              Le Client peut résilier son abonnement à tout moment depuis son espace client ou en contactant <ProtectedEmail />.
            </p>
            <p className="mb-4">
          ...
          <section>
            ...
            <p className="mb-4">
              Le support client est accessible par email à : <ProtectedEmail />
            </p>
