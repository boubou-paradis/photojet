...
const REPLY_TO = 'animajet3@gmail.com'
...
export async function sendTrialWelcomeEmail(params: {
  ...
  const { to, password, sessionCode, expiresAt } = params

  // Format expiration date
  const expiresFormatted = expiresAt.toLocaleString('fr-FR', {
    weekday: 'long',
    day: 'numeric',
    month: 'long',
    hour: '2-digit',
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Votre compte AnimaJet - Essai gratuit</title>
</head>
<body style="margin: 0; padding: 0; background-color: #0D0D0F; font-family: 'Segoe UI', Arial, Helvetica, sans-serif; -webkit-font-smoothing: antialiased;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #0D0D0F;">
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; width: 100%;">
          ...
          <tr>
            <td align="center" style="background: linear-gradient(180deg, #1A1A1E 0%, #242428 100%); padding: 50px 40px 40px 40px; border-radius: 20px 20px 0 0;">
              ...
              <h1 style="margin: 30px 0 0 0; color: #D4AF37; font-size: 32px; font-weight: 700; letter-spacing: -0.5px;">
          ...
          <!-- Trial Badge -->
          <tr>
            <td style="background-color: #1A1A1E; padding: 0 40px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background: linear-gradient(135deg, rgba(212, 175, 55, 0.15) 0%, rgba(212, 175, 55, 0.05) 100%); border: 1px solid rgba(212, 175, 55, 0.3); border-radius: 12px;">
                <tr>
          ...
          <!-- Main Content -->
          <tr>
            <td style="background-color: #1A1A1E; padding: 35px 40px;">
              <p style="margin: 0 0 30px 0; color: #E5E5E7; font-size: 16px; line-height: 1.7;">
                Bonjour !<br><br>
                Voici vos identifiants pour vous connecter a AnimaJet :
              </p>
                ...
                <tr>
                  <td align="center">
                    <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td align="center" style="background: linear-gradient(135deg, #D4AF37 0%, #F4D03F 50%, #D4AF37 100%); border-radius: 14px; box-shadow: 0 4px 20px rgba(212, 175, 55, 0.4);">
                          <a href="${APP_URL}/login" target="_blank" style="display: inline-block; padding: 20px 55px; color: #1A1A1E; font-size: 16px; font-weight: 700; text-decoration: none; letter-spacing: 0.5px;">
              ...
              <!-- Subscription Notice -->
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top: 35px; background: #2E2E33; border-radius: 12px;">
                <tr>
                  <td style="padding: 20px;">
                    <p style="margin: 0 0 8px; color: #ffffff; font-size: 14px; font-weight: 600;">
                      Vous aimez AnimaJet ?
                    </p>
                    <p style="margin: 0; color: #B0B0B5; font-size: 14px;">
                      Passez a l'abonnement <strong style="color: #D4AF37;">29,90€/mois</strong> pour utiliser AnimaJet le week-end sur vos evenements !
                    </p>
                  </td>
                </tr>
              </table>
              ...
              <!-- Info Text -->
              <p style="margin: 30px 0 0 0; color: #6B6B70; font-size: 14px; text-align: center; line-height: 1.7;">
                Conservez cet email precieusement pour vous reconnecter.
              </p>
            </td>
          </tr>
    ...
    console.error('[Trial Welcome Email] Error:', error instanceof Error ? error.message : error)
    return { success: false, error }
  }
}

export async function sendTrialExpiredEmail(params: { to: string }) {
  if (!resend) {
    return { success: false, error: 'Resend not configured' }
  }
...
<body style="margin: 0; padding: 0; background-color: #0D0D0F; font-family: 'Segoe UI', Arial, Helvetica, sans-serif;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #0D0D0F;">
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; width: 100%;">
          ...
          <tr>
            <td style="background-color: #1A1A1E; padding: 40px;">
              ...
              <!-- Pricing highlight -->
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background: linear-gradient(145deg, #242428 0%, #1E1E22 100%); border: 1px solid rgba(212, 175, 55, 0.3); border-radius: 12px; margin-bottom: 30px;">
                <tr>
                  <td style="padding: 25px; text-align: center;">
                    <p style="margin: 0 0 8px; color: #ffffff; font-size: 16px; font-weight: 600;">Abonnement AnimaJet</p>
                    <p style="margin: 0; color: #D4AF37; font-size: 28px; font-weight: 700;">29,90 &euro;/mois</p>
                    <p style="margin: 8px 0 0; color: #9A9AA0; font-size: 13px;">Sans engagement - Acces illimite week-end inclus</p>
                  </td>
                </tr>
              </table>
    ...
    console.error('[Email] Trial expired email error:', error instanceof Error ? error.message : error)
    return { success: false, error }
  }
}
...
export async function sendRenewalConfirmationEmail(params: {
  ...
  const { to, nextBillingDate } = params

  // Format date in French
  const formattedDate = new Date(nextBillingDate).toLocaleDateString('fr-FR', {
    weekday: 'long',
    day: 'numeric',
    month: 'long',
    year: 'numeric',
...
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Abonnement renouvele</title>
</head>
<body style="margin: 0; padding: 0; background-color: #0D0D0F; font-family: 'Segoe UI', Arial, Helvetica, sans-serif;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #0D0D0F;">
    <tr>
      <td align="center" style="padding: 40px 20px;">
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; width: 100%;">
          ...
          <!-- Green Success Glow -->
          <tr>
            <td height="3" style="background: linear-gradient(90deg, transparent 0%, #4CAF50 20%, #66BB6A 50%, #4CAF50 80%, transparent 100%); border-radius: 20px 20px 0 0;"></td>
          </tr>
          ...
          <tr>
            <td align="center" style="background: linear-gradient(180deg, #1A1A1E 0%, #242428 100%); padding: 40px; border-radius: 20px 20px 0 0;">
              <img src="https://animajet.fr/logo.png" alt="AnimaJet" width="120" height="120" style="display: block; width: 120px; height: 120px; border: 0; border-radius: 15px;" />
              <h1 style="margin: 25px 0 0 0; color: #4CAF50; font-size: 26px; font-weight: 700;">
          ...
          <tr>
            <td style="background-color: #1A1A1E; padding: 40px;">
              <p style="margin: 0 0 25px; color: #E5E5E7; font-size: 16px; line-height: 1.7;">
                Bonne nouvelle ! Votre abonnement AnimaJet a ete renouvele avec succes. Vous avez de nouveau acces a toutes les fonctionnalites.
              </p>

              <!-- Next billing info -->
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background: linear-gradient(145deg, #242428 0%, #1E1E22 100%); border: 1px solid rgba(76, 175, 80, 0.3); border-radius: 12px; margin-bottom: 30px;">
                <tr>
                  <td style="padding: 25px;">
                    <p style="margin: 0 0 8px; color: #6B6B70; font-size: 11px; text-transform: uppercase; letter-spacing: 2px; font-weight: 600;">Prochaine echeance</p>
                    <p style="margin: 0; color: #D4AF37; font-size: 20px; font-weight: 700;">${formattedDate}</p>
                  </td>
                </tr>
              </table>

              <p style="margin: 0 0 35px; color: #9A9AA0; font-size: 15px; line-height: 1.7;">
                Vos sessions et photos sont de nouveau accessibles. Merci pour votre confiance !
              </p>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td align="center">
                    <a href="${APP_URL}/login" style="display: inline-block; background: linear-gradient(135deg, #D4AF37 0%, #F4D03F 100%); color: #1A1A1E; text-decoration: none; padding: 18px 45px; border-radius: 12px; font-size: 16px; font-weight: 700; box-shadow: 0 4px 20px rgba(212, 175, 55, 0.4);">
                      Acceder a mon dashboard
                    </a>
                  </td>
                </tr>
    ...
    console.error('[Email] Renewal confirmation error:', error instanceof Error ? error.message : error)
    return { success: false, error }
  }
}
...
export async function sendWeekendPassEmail(params: {
  ...
  const { to, password, sessionCode, validUntil } = params
  ...
  try {
    const result = await resend.emails.send({
      ...
      to,
      replyTo: REPLY_TO,
      subject: '🎉 Votre Pass Week-end AnimaJet est activé !',
      html: `
<!DOCTYPE html>
<html lang="fr">
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Votre Pass Week-end AnimaJet</title>
</head>
<body style="margin: 0; padding: 0; background-color: #0D0D0F; font-family: 'Segoe UI', Arial, Helvetica, sans-serif; -webkit-font-smoothing: antialiased;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #0D0D0F;">
    <tr>
      <td align="center" style="padding: 40px 20px;">
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; width: 100%;">
          ...
          <!-- Header -->
          <tr>
            <td align="center" style="background: linear-gradient(180deg, #1A1A1E 0%, #242428 100%); padding: 50px 40px 40px; border-radius: 20px 20px 0 0;">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td align="center" style="padding: 15px; background: radial-gradient(circle at center, rgba(212,175,55,0.15) 0%, transparent 70%); border-radius: 50%;">
                    <img src="https://animajet.fr/logo.png" alt="AnimaJet" width="160" height="160" style="display: block; width: 160px; height: 160px; border: 0; border-radius: 20px;" />
                  </td>
                </tr>
              </table>
              <h1 style="margin: 30px 0 0 0; color: #D4AF37; font-size: 30px; font-weight: 700;">
                Votre Pass Week-end est activé !
              </h1>
              <p style="margin: 12px 0 0 0; color: #9A9AA0; font-size: 16px; line-height: 1.5;">
                Profitez d'AnimaJet pour votre événement ce week-end
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="background-color: #1A1A1E; padding: 0 40px 30px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background: linear-gradient(135deg, rgba(212,175,55,0.2) 0%, rgba(212,175,55,0.08) 100%); border: 2px solid #D4AF37; border-radius: 14px;">
                <tr>
                  <td style="padding: 20px 25px; text-align: center;">
                    <p style="margin: 0 0 6px; color: #D4AF37; font-size: 13px; text-transform: uppercase; letter-spacing: 2px; font-weight: 600;">⏰ Accès valable jusqu'au</p>
                    <p style="margin: 0; color: #FFFFFF; font-size: 20px; font-weight: 700;">${validUntilStr}</p>
                    <p style="margin: 10px 0 0; color: #E53935; font-size: 13px; font-weight: 600;">⚠️ Pensez à récupérer vos photos avant lundi 12h !</p>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <!-- Credentials -->
          <tr>
            <td style="background-color: #1A1A1E; padding: 0 40px 35px;">
              <p style="margin: 0 0 20px; color: #E5E5E7; font-size: 16px; line-height: 1.7;">
                Voici vos identifiants de connexion :
              </p>
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background: linear-gradient(145deg, #242428 0%, #1E1E22 100%); border: 2px solid #D4AF37; border-radius: 16px;">
                <tr>
                  <td style="padding: 30px;">
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 20px;">
                      <tr>
                        <td width="50" valign="top">
                          <td style="width: 42px; height: 42px; background: rgba(212,175,55,0.15); border-radius: 10px; text-align: center; vertical-align: middle; display: block; line-height: 42px; font-size: 20px;">&#9993;</td>
                        </td>
                        <td style="padding-left: 15px;">
                          <p style="margin: 0 0 5px; color: #6B6B70; font-size: 11px; text-transform: uppercase; letter-spacing: 2px;">Votre email</p>
                          <p style="margin: 0; color: #FFFFFF; font-size: 15px; font-weight: 600;">${to}</p>
                        </td>
                      </tr>
                    </table>

                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 20px;"><tr><td style="border-bottom: 1px solid rgba(212,175,55,0.2);"></td></tr></table>
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 20px;">
                      <tr>
                        ...
                        <td style="padding-left: 15px;">
                          <p style="margin: 0 0 5px; color: #6B6B70; font-size: 11px; text-transform: uppercase; letter-spacing: 2px;">Mot de passe</p>
                          <p style="margin: 0; color: #D4AF37; font-size: 20px; font-weight: 700; font-family: 'Courier New', monospace; letter-spacing: 2px;">${password}</p>
                        </td>
                      </tr>
                    </table>
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        ...
                        <td style="padding-left: 15px;">
                          <p style="margin: 0 0 5px; color: #6B6B70; font-size: 11px; text-transform: uppercase; letter-spacing: 2px;">Code de votre session</p>
                          <p style="margin: 0; color: #D4AF37; font-size: 36px; font-weight: 800; font-family: 'Courier New', monospace; letter-spacing: 6px;">${sessionCode}</p>
                          <p style="margin: 8px 0 0; color: #6B6B70; font-size: 13px;">Partagez ce code avec vos invités !</p>
                        </td>
                      </tr>
                    </table>
          ...
          <!-- CTA -->
          <tr>
            <td align="center" style="background-color: #1A1A1E; padding: 0 40px 35px;">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td align="center" style="background: linear-gradient(135deg, #D4AF37 0%, #F4D03F 50%, #D4AF37 100%); border-radius: 14px; box-shadow: 0 4px 20px rgba(212,175,55,0.4);">
          ...
          <tr>
            <td style="background-color: #1A1A1E; padding: 0 40px 35px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background: rgba(229,57,53,0.08); border: 1px solid rgba(229,57,53,0.3); border-radius: 12px;">
                <tr>
                  <td style="padding: 18px 20px;">
                    <p style="margin: 0 0 6px; color: #E53935; font-size: 14px; font-weight: 700;">📥 Important — Téléchargez vos photos avant lundi 12h</p>
                    <p style="margin: 0; color: #9A9AA0; font-size: 13px; line-height: 1.6;">
                      Dans votre dashboard → onglet Photos → bouton "Télécharger l'album ZIP". Votre accès se termine automatiquement lundi à 12h00.
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="background-color: #0D0D0F; padding: 30px 40px; border-radius: 0 0 20px 20px; border-top: 1px solid #2A2A2E;">
              ...
              <p style="margin: 0; color: #4A4A4F; font-size: 12px; text-align: center; line-height: 1.8;">
                &copy; 2025 AnimaJet - Tous droits réservés<br>
                <span style="color: #6B6B70;">Créé par <strong style="color: #D4AF37;">MG Events Animation</strong></span>
              </p>
            </td>
          </tr>
    ...
    console.error('[Email] Weekend pass email error:', error instanceof Error ? error.message : error)
    return { success: false, error }
  }
}
